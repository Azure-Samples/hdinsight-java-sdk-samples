...
public class CreateLoadBasedAutoscaleEnabledHadoopCluster {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf("Starting to create Autoscale enabled HDInsight Hadoop cluster %s\n",
    ...
    System.out.printf("Finished creating Autoscale enabled HDInsight Hadoop cluster %s\n",
        AzureConfig.CLUSTER_NAME);
  }
}
